<div {{ $attributes->merge(['class' => 'flex items-center']) }}>
    <a
      href="http://www.linkedin.com/in/elmiguehg"
      target="_blank"
      class="
           w-10
           h-10
      ...
      "
    >
    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="20" height="28" viewBox="0 0 48 48">
    ...
    <a
      href="https://github.com/elmiguehg"
      target="_blank"
      class="
         w-10
         h-10
